        ...
        <main className="font-grotesk bg-gradient-to-br from-gray-50 to-gray-100 mb-6 px-4 sm:px-6 lg:px-16 py-12">
            ...
            <div className="grid grid-cols-2 gap-3">
                <article className="flex h-44 w-full bg-white rounded-2xl border border-gray-200">
                    <h3 className="grid place-items-center border-r border-gray-200 text-3xl font-mono font-bold text-gray-500 h-full px-8">1.2</h3>
                ...
                <article className="flex h-44 w-full bg-white rounded-2xl border border-gray-200">
                    <h3 className="grid place-items-center border-r border-gray-200 text-3xl font-mono font-bold text-gray-500 h-full px-8">1.4</h3>
                    <div className="flex gap-2 h-full w-full p-2">
                ...
                <article className="flex h-44 w-full bg-white rounded-2xl border border-gray-200">
                    <h3 className="grid place-items-center border-r border-gray-200 text-3xl font-mono font-bold text-gray-500 h-full px-8">1.6</h3>
                    <div className="flex gap-2 h-full w-full p-2">
                ...
                <article className="flex h-44 w-full bg-white rounded-2xl border border-gray-200">
                    <h3 className="grid place-items-center border-r border-gray-200 text-3xl font-mono font-bold text-gray-500 h-full px-8">1.8</h3>
                    <div className="flex gap-2 h-full w-full p-2">
                ...
                <article className="flex h-44 w-full bg-white rounded-2xl border border-gray-200">
                    <h3 className="grid place-items-center border-r border-gray-200 text-3xl font-mono font-bold text-gray-500 h-full px-8">2.0</h3>
                    <div className="flex gap-2 h-full w-full p-2">
                ...
                <article className="flex h-44 w-full bg-white rounded-2xl border border-gray-200">
                    <h3 className="grid place-items-center border-r border-gray-200 text-sm font-bold text-gray-500 h-full px-3">Personalizado</h3>
                    <div className="flex gap-2 h-full w-full p-2">
