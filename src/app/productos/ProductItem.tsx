...
export default function ProductItem(props: { 
  ...
  return (
    <div className={`group w-full min-h-70 bg-white rounded-3xl md:rounded-2xl overflow-hidden border border-gray-200 has-focus-visible:outline-2 ${clickable ? 'cursor-pointer transition-all duration-300 hover:-translate-y-0.5  hover:shadow-lg' : 'shadow-lg/2'}`}>
      {clickable ? (
        <Link href={path}>
