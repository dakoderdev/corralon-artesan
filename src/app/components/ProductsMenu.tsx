...
export default function ProductsMenu() {
    return (
        <section className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-8 sm:h-auto lg:h-dvh gap-y-8 sm:gap-y-3 gap-x-6 px-6 py-12 sm:p-8 md:px-18 md:py-20 bg-zinc-200/70">
